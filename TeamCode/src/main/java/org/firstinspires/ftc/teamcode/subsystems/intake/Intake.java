...
public class Intake {
    ...
    double[] actuationAngles = new double[] {3.2556096190, 0.20612106138, 0.1576726368, 0.0392242122, -0.1112242122}; // 1 pixel --> 5 pixel
    double actuationFullyUpAngle = 0.078448424553;
