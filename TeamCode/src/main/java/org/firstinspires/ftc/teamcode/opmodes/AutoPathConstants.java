...
public class AutoPathConstants {
    ...
    public static Pose2d groundPreloadCenterOffset = new Pose2d(6, 28.5, 0);
    ...
    public static Pose2d boardPreload =              new Pose2d(42, -36, Math.PI);
    ...
    public static Pose2d targetBoard =               new Pose2d(60,-36,0);
}
