...
public class Droppers {
    ...
    public static double leftDownAngle = 0.855;
    public static double leftReleaseAngle = 4.625;

    public static double rightDownAngle = 4.2088;
    public static double rightReleaseAngle = 0.5827;
