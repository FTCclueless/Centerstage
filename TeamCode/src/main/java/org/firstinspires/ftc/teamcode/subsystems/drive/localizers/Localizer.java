...
public class Localizer {
    ...
    public Localizer(HardwareMap hardwareMap, Sensors sensors, Drivetrain drivetrain, String color, String expectedColor) {
        ...
        encoders[0] = new Encoder(new Pose2d(0,7.48840945 * 3596.1987614308046 / 3600.0 * 3595.4117685439833 / 3600.0),  1); // left
        encoders[1] = new Encoder(new Pose2d(0,-7.008314962 * 3596.1987614308046 / 3600.0 * 3595.4117685439833 / 3600.0),-1); // right
        encoders[2] = new Encoder(new Pose2d(-8.50195275, 0),  -1); // back
