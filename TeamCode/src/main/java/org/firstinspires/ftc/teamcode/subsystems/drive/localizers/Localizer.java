...
//        encoders[0] = new Encoder(new Pose2d(0,3.522728259257813),  -1); // left
//        encoders[1] = new Encoder(new Pose2d(0,-3.921522130825),1); // right
//        encoders[2] = new Encoder(new Pose2d(-5.1000401484, 0),  -1); // back (7.1660442092285175)
